...
- [Relay access](../capabilities/relay-access.md) for the topology and auth flow (identical here).
- [Security posture](../operations/security.md) for what the relay sees and what it doesn't.
