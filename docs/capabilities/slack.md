...
- No attachment relay yet. Photos posted in Slack are not currently downloaded and forwarded to agents; see [Attachments](attachments.md) for supported file-transfer surfaces.
