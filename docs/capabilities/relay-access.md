...
Your API key is in `~/.repowire/config.yaml` under `relay.api_key`. Keep it secret — see [security posture](../operations/security.md).
...
- [Self-hosting](../guides/self-host-relay.md) if you don't want to depend on `repowire.io`.
- [Operations: relay](../operations/relay.md) for the relay topology.
- [Security posture](../operations/security.md) for what the relay can and can't see.
